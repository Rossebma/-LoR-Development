...
FOB_box_typename = "lsb_props_box_var1";                            // This is the FOB as a container.
FOB_truck_typename = "RD501_bantha_mkii";                                // This is the FOB as a vehicle.
...
KP_liberation_boat_classname = "RD501_LAAT_MKIII_Balls";                 // These are the boats which spawn at the stern of the Freedom.
...
KP_liberation_heli_slot_building = "Land_OPTRE_landingpad";              // The helipad used to increase the GLOBAL rotary-wing cap.
...
light_vehicles = [
    ["RD501_gar_barc",50,0,25],                                        // Quad Bike
    ["RD501_bantha_mkii",140,60,60],                          // M1220 (Mk19)
    ["MRC_ATRT_15L",120,0,60]                              // M1230A1 (MEDEVAC)
];

heavy_vehicles = [
    ["SWLG_tanks_tx130",200,40,100],                                // M113A3 (M2)
    ["3as_saber_super",200,40,100],                                 // M113A3 (M2)
    ["3as_saber_m1G",200,40,100],                                    // M113A3 (M2)
    ["212th_B_APC_Wheeled_fs_cannon_F",200,40,100]                  // M113A3 (M2)

];

air_vehicles = [
    ["RD501_LAAT_MKIII_Balls",75,0,25],                                 // AR-2 Darter
    ["RD501_LAAT_R",100,0,250],                                         // AL-6 Pelican (Cargo)
    ["RD501_Laat_C",200,0,100],                                         // MH-9 Hummingbird
    ["RD501_arc_170_blue",1250,450,175],                                // AH-9 Pawnee
    ["RD501_arc_170_razor",1250,450,175],                              // MH-6M Little Bird
    ["RD501_arc_170_red",1250,450,175]                                 // MH-6M Little Bird
];

static_vehicles = [
    ["RD501_Republic_Static_AA_LR",200,40,100],
    ["RD501_stat_Striker",250,500,0],                                     // MIM-145 Defender
    ["RD501_stat_Railgun",250,500,0]                                     // MIM-145 Defender
];
